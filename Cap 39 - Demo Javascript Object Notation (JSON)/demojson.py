...
#####################################################################
#IMPORTS
import requests # yet i dont use it
import json
...
# read the JSON file in a path
file_path = "/home/crekoj/Documentos/Jesus/Desarrollo/0 - Learn Python/Cap 39 - Demo Javascript Object Notation (JSON)/demoexample.json"

# OPEN and load the JSON file
with open(file_path, "r", encoding="utf-8") as file:
    data = json.load(file)

# now print the dictionary here
print(data)
